...
public class Productbean {
    ...
    private String product_name; //상품이름P
    ...
    private int product_review_score;
    
    public int getProduct_review_score() {
		return product_review_score;
	}
	public void setProduct_review_score(int product_review_score) {
